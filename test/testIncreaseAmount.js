...
function getIncreaseAmountCalling(nftId, amount, veARCAddress) {
    const veARC = new web3.eth.Contract(abi, veARCAddress);
    return veARC.methods.increaseAmount(nftId, amount).encodeABI();
}
...
describe("test increase amount", function () {
    ...
    it("at 20 WEEK, create a new lock, increase amount of 3", async function () {
        ...
        const callings = [
            ...
            getIncreaseAmountCalling(nftId, amount, veARC.address)
        ];
