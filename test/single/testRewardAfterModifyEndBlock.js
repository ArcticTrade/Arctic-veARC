...
describe("test increase unlock time", function () {
    ...
    it("modify endblock", async function () {
        ...
        await tryModifyEndBlock(veARC, signer, '225');

        const deltaGlobalAcc3 = stringDiv(stringMul(stringMul(rewardPerBlock, '110'), q128), stakeARCAmount);
        ...
        const deltaGlobalAcc4 = stringDiv(stringMul(stringMul(rewardPerBlock, '25'), q128), stakeARCAmount);
